/*******************************************************
    Template Name    : Matt Hickling - Personal Portfolio Landing Page Template
    Author           : Cute
    Version          : 1.0
    Created          : 2020
...
(function($) {
	...
	/*START CONTACT MAP JS*/
			if ($('.map-canvas').length) {
				...
				// Dursley town center location
				var dursleyLat = 51.6845;
				var dursleyLng = -2.3601;


				var mapOptions = {
					center: new google.maps.LatLng(dursleyLat, dursleyLng),
					zoom: 12,
					scrollwheel: false,
					panControl: true,
				...
				var initMap = function() {
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(dursleyLat, dursleyLng),
						map: map,
						icon: myIcon
					});
